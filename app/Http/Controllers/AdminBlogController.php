<?php namespace App\Http\Controllers;
	...
	class AdminBlogController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kategori Id","name"=>"kategori_id","join"=>"kategori,kategori"];
			...
			$this->form[] = ['label'=>'Kategori Id','name'=>'kategori_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'kategori,kategori'];
			...
			$this->form[] = ['label'=>'Isi','name'=>'isi','type'=>'wysiwyg','validation'=>'string|max:60000','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Gambar','name'=>'gambar','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			//$this->form[] = ['label'=>'Slug','name'=>'slug','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Isi','name'=>'isi','type'=>'wysiwyg','validation'=>'string|max:6000','width'=>'col-sm-10'];
			# OLD END FORM
